...
class FilesActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Referencias UI
        val toolbar = findViewById<Toolbar>(R.id.toolbarFiles)
    ...
    private fun loadFilesInfo() {
        ...
        // 2SEGUNDO: Si llegaron vacíos

        if (token.isNullOrEmpty() || userId == -1) {
            val sharedPreferences = getSharedPreferences("aula_virtual_prefs", MODE_PRIVATE)
